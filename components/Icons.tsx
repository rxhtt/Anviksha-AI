...
export const IconPatients = Users;
export const IconHistory = History;
export const IconAi = BrainCircuit;
...
export const IconHeart = HeartPulse;
export const IconLung = Wind;
export const IconBone = Bone;
export const IconAlert = AlertTriangle;
export const IconJson = FileJson;
